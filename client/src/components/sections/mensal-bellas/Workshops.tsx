...
// Imagens locais
import imgSpaDay from "./assets/workshops/spaday.jpeg";
import imgWaiting from "./assets/workshops/waiting.jpg";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
          ...
          <article className="rounded-2xl bg-white p-0 shadow border border-transparent hover:shadow-md transition overflow-hidden">
            <img src={imgSpaDay} alt="" className="h-40 w-full object-cover" loading="lazy" />
            <div className="p-6">
                ...
                >
                  <a
                    href={buildWAUrl(
                      ...
                      { utm_source: "site", utm_medium: "mensal-bellas", utm_content: "workshop_p12" }
                    )}
          ...
          {/* Card 2 - Planos 3+ */}
          <article className="rounded-2xl bg-white p-0 shadow border border-transparent hover:shadow-md transition overflow-hidden">
            <img src={imgWaiting} alt="" className="h-40 w-full object-cover" loading="lazy" />
            <div className="p-6">
              <div className="flex items-center gap-2">
                <div
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full"
                ...
                >
                  <a
                    href={buildWAUrl(
                      ...
                      { utm_source: "site", utm_medium: "mensal-bellas", utm_content: "grupo_3plus" }
                    )}
