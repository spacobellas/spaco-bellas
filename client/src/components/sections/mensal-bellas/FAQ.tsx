...
import cover from "@assets/generated_images/Luxury_spa_treatment_room_eeed824b.png";
  ...
  return (
    <section aria-labelledby="faq-title" className="py-10 md:py-14" style={{ backgroundColor: COLORS.lilacBg }}>
      <div className="container mx-auto px-4">
        ...
        <h2 id="faq-title" className="mt-4 text-2xl md:text-3xl font-semibold text-center" style={{ color: COLORS.gold }}>
          Dúvidas frequentes
        </h2>
