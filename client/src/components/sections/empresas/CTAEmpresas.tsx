...
export function CTAEmpresas() {
  return (
    <section className="relative py-12 md:py-16 overflow-hidden" style={{ backgroundColor: COLORS.lilacBg, color: COLORS.text }}>
      <div className="absolute inset-0 -z-10">
        <img src={bg} alt="" className="h-full w-full object-cover opacity-10" loading="lazy" />
      </div>

      <div className="container mx-auto px-4 text-center">
        <h2 className="text-2xl md:3xl font-semibold" style={{ color: COLORS.gold }}>
        ...
        <a
          href={buildWAUrl("Olá! Quero meu orçamento agora do Bellas Corporativo.", { utm_source: "site", utm_medium: "empresas", utm_content: "cta_final" })}
          target="_blank"
        ...
        <p className="mt-3 text-xs opacity-75">Spaço Bellas: onde cuidar de gente é o melhor negócio.</p>
      </div>
    </section>
  );
}
