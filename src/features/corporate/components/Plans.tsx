// src/features/corporate/components/Plans.tsx
import { Button } from "@/components/ui/button";
import { Check, Sparkles, Crown, Stars } from "lucide-react";
import imgLight from "@/assets/images/membership/plansgrid/relax.jpg";
import imgPremium from "@/assets/images/membership/plansgrid/luxuryspa.jpeg";
import imgCorporate from "@/assets/images/membership/plansgrid/royal.jpg";
      ...
      <div className="container mx-auto px-4">
        ...
        <header className="mx-auto max-w-3xl text-center mt-4">
          ...
          <p className="mt-2 opacity-90">
            Por menos que um coffee break, entregue o melhor dia do ano para sua
            equipe.
          </p>
        </header>
            ...
            >
              ...
              <div className="mt-6">
                ...
                >
                  <a
                    href={buildWAUrl(
                      `Olá! Quero orçamento do pacote ${p.name}.`,
                      {
                        utm_source: "site",
                        utm_medium: "empresas",
