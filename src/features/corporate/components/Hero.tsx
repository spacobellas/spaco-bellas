  ...
  return (
    <section className="relative isolate overflow-hidden" style={{ backgroundColor: COLORS.lilacBg }}>
      ...
      <div 
        ...
        style={{ background: "linear-gradient(180deg, rgba(246,237,249,0.9) 0%, rgba(246,237,249,0.7) 40%, rgba(246,237,249,0.95) 100%)" }} 
      />
      <div className="container mx-auto px-4 py-12 md:py-16 text-center">
        <span 
          className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs" 
          style={{ backgroundColor: "#FAF8FB", color: "#8E5BAE", border: "1px solid rgba(142,91,174,0.12)" }}
        >
          <Sparkles size={14} /> Bem‑estar, propósito e alta performance
        </span>
        <h1 
          className="mt-4 font-serif" 
          style={{ color: COLORS.gold, fontSize: "clamp(2rem, 5.5vw, 3.25rem)", lineHeight: 1.1 }}
        >
