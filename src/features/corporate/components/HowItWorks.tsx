...
const steps: Step[] = [
  {
    ...
    bullets: [
      "Montagem rápida e silenciosa",
      "Higiene e organização de alto padrão",
      "Fluxo pensado para zero gargalo",
    ],
  },
  {
    icon: Music,
    ...
    bullets: [
      "Massagem relaxante + atenção ao detalhe",
      "Equipe treinada para acolher",
      "Pausa produtiva sem interromper a operação",
    ],
  },
  {
    icon: ClipboardList,
    ...
    bullets: [
      "Mini pesquisa logo após a experiência",
      "Relatório de clima: antes/depois e insights",
  ...
  },
  {
    ...
    bullets: [
      "Registros discretos e bem dirigidos",
      "Entrega pronta para intranet/newsletter",
      "Clipes curtos para social",
    ],
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <header className="mx-auto max-w-3xl text-center mt-4">
          ...
          <p className="mt-2 opacity-90">
            Montamos um mini spa sensorial na sua empresa: cuidado humano,
            fluidez operacional e entregas claras para decisão.
          </p>
        </header>
