      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            >
              Bem‑estar, propósito e alta performance para empresas, escolas e
              condomínios — cuidado humano com entregas mensuráveis para
              decisões de gestão.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a
                  href={waUrl(
                    "Olá! Quero levar o Bellas Corporativo para minha empresa.",
                  )}
                  target="_blank"
          ...
          <div>
            ...
            <a
              href={waUrl(
                "Olá! Quero meu orçamento do Bellas Corporativo (pacote e datas).",
              )}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <a
                href={waUrl(
                  "Olá! Quero conhecer o Programa Mulheres VIP Bellas.",
                )}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/20 hover:bg-white/10 transition-all hover:scale-110"
