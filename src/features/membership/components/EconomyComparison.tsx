// src/features/membership/components/EconomyComparison.tsx
import { BadgePercent, CheckCircle2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import { useMemo } from "react";
import {
  FaHandSparkles, // Hands + feet
  FaWind, // Hair brushing
...
const SERVICES: Item[] = [
  ...
  {
    label: "Escova + hidratação (2×/mês)",
    avulso: 160,
    plano: "Incluído",
    Icon: FaWind,
  },
  {
    label: "Skin Care + Sobrancelha",
    avulso: 100,
    plano: "Incluído",
    Icon: FaFaceSmileBeam,
  },
  {
    label: "Massagem ou relaxamento",
    avulso: 180,
    plano: "Incluído",
    Icon: FaSpa,
  },
  {
    label: "Banheira aromática",
    avulso: 180,
    plano: "Incluída no Plano 2+",
    Icon: FaBath,
  },
];
...
export function EconomyComparison() {
    ...
    >
      <div className="container mx-auto px-4">
        <header className="max-w-3xl mx-auto text-center">
          ...
          >
            Você já gasta isso todo mês — só que em lugares diferentes (e sem
            viver a experiência).
          </h2>
          <p className="mt-2 opacity-90">
            Veja quanto uma mulher normalmente investe por mês e como o Bellas
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2 max-w-4xl mx-auto">
          ...
          <article className="rounded-2xl bg-white p-5 shadow">
            ...
            <div className="mt-4 border-t pt-3 space-y-2">
              <p className="text-sm">
                Planos a partir de{" "}
                <span className="font-semibold">R$ {PLANO_MIN}/mês</span>.
              </p>
              <p className="text-sm">
                Economia de até{" "}
                <span className="font-semibold">R$ {ECONOMIA_MES_ATE}/mês</span>{" "}
        ...
        <div className="mt-6 max-w-3xl mx-auto text-center">
          <p className="text-sm md:text-base opacity-90">
            Além de economizar até R$ {ECONOMIA_MES_ATE} por mês, você ganha
            algo que dinheiro nenhum compra: tempo pra si, acolhimento e
            pertencimento.
          </p>
          <div className="mt-4 flex justify-center">
            ...
            >
              <a
                href="#planos"
                aria-label="Ver planos do Programa Mulheres VIP Bellas"
              >
                Ver planos
              </a>
            </Button>
