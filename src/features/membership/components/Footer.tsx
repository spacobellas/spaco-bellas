          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition" style={{ color: COLORS.textLight }}>
                  {CONTACT_CONFIG.PHONE_DISPLAY}
                </a>
              </li>
              <li className="flex items-start gap-2">
                <Mail size={16} className="mt-0.5 flex-shrink-0" style={{ color: COLORS.lilac }} />
                <a href="mailto:contato@spacobellas.com.br" className="hover:opacity-80 transition" style={{ color: COLORS.textLight }}>
          ...
          <div>
            ...
            <form className="flex flex-col gap-2 mb-4">
              <input 
                ...
                style={{ color: COLORS.text, borderColor: "rgba(255,255,255,0.2)" }} 
              />
              <button 
                type="submit" 
